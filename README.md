...
[![Python](https://img.shields.io/badge/Python-3776AB?style=flat-square&logo=python&logoColor=white)](classes/README.md)
[![JavaScript](https://img.shields.io/badge/JavaScript-F7DF1E?style=flat-square&logo=javascript&logoColor=black)](classes/README.md)
[![TypeScript](https://img.shields.io/badge/TypeScript-3178C6?style=flat-square&logo=typescript&logoColor=white)](classes/README.md)
[![Java](https://img.shields.io/badge/Java-ED8B00?style=flat-square&logo=openjdk&logoColor=white)](classes/README.md)
[![C#](https://img.shields.io/badge/C%23-512BD4?style=flat-square&logo=dotnet&logoColor=white)](classes/README.md)
[![Go](https://img.shields.io/badge/Go-00ADD8?style=flat-square&logo=go&logoColor=white)](classes/README.md)
[![Rust](https://img.shields.io/badge/Rust-000000?style=flat-square&logo=rust&logoColor=white)](classes/README.md)
[![C](https://img.shields.io/badge/C-A8B9CC?style=flat-square&logo=c&logoColor=black)](classes/README.md)
[![SQL](https://img.shields.io/badge/SQL-4479A1?style=flat-square&logo=postgresql&logoColor=white)](classes/README.md)
[![PHP](https://img.shields.io/badge/PHP-777BB4?style=flat-square&logo=php&logoColor=white)](classes/README.md)
...
```mermaid
flowchart LR
    A["🧠 00 Pensamiento<br/>computacional"] --> B["🌳 01 Atlas y<br/>genealogía"]
    A --> C["🛠️ 02 Toolchains<br/>y comandos"]
    B --> D["🔤 03 Valores, tipos<br/>y variables"]
    C --> D
    D --> E["🔀 04 Control del<br/>programa"]
    E --> F["🧩 05 Funciones y<br/>modularidad"]
    F --> G["🗃️ 06 Datos y<br/>estructuras"]
    G --> H["🎭 07 Paradigmas"]
    G --> I["⚙️ 08 Cómo funcionan<br/>los lenguajes"]
    H --> J["🏗️ 09 Ingeniería de<br/>software políglota"]
    I --> J
    I --> K["🔌 10 Interoperabilidad<br/>y fronteras"]
    J --> K
    K --> L["🎓 11 Proyecto<br/>integrador"]
```
...
[![GitHub stars](https://img.shields.io/github/stars/vladimiracunadev-create/polyglot-programming-labs?style=social)](https://github.com/vladimiracunadev-create/polyglot-programming-labs/stargazers)
[![GitHub forks](https://img.shields.io/github/forks/vladimiracunadev-create/polyglot-programming-labs?style=social)](https://github.com/vladimiracunadev-create/polyglot-programming-labs/network/members)
