...
Comprender **pseudocódigo neutral: escribir sin lenguaje** como conocimiento transferible: su forma independiente del lenguaje, cómo se expresa en el núcleo de 10 lenguajes y qué cambia (sintáctica, semántica o paradigmáticamente) de una familia a otra.
...
```bash
python scripts/verificar_equivalencia.py 007-pseudocodigo-neutral-escribir-sin-lenguaje
```
