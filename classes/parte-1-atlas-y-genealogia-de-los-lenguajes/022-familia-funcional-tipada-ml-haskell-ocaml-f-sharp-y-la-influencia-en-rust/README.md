...
Comprender **familia funcional tipada (ml): haskell, ocaml, f# y la influencia en rust** como conocimiento transferible: su forma independiente del lenguaje, cómo se expresa en el núcleo de 10 lenguajes y qué cambia (sintáctica, semántica o paradigmáticamente) de una familia a otra.
...
```bash
python scripts/verificar_equivalencia.py 022-familia-funcional-tipada-ml-haskell-ocaml-f-sharp-y-la-influencia-en-rust
```
