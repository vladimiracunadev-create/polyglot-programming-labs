...
Comprender **familia lógica y declarativa: sql, prolog, datalog** como conocimiento transferible: su forma independiente del lenguaje, cómo se expresa en el núcleo de 10 lenguajes y qué cambia (sintáctica, semántica o paradigmáticamente) de una familia a otra.
...
```bash
python scripts/verificar_equivalencia.py 024-familia-logica-y-declarativa-sql-prolog-datalog
```
