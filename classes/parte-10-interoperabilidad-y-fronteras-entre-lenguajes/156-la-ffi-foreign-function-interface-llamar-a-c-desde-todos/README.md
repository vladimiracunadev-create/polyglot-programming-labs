...
Comprender **la ffi (foreign function interface): llamar a c desde todos** como conocimiento transferible: su forma independiente del lenguaje, cómo se expresa en el núcleo de 10 lenguajes y qué cambia (sintáctica, semántica o paradigmáticamente) de una familia a otra.
...
```bash
python scripts/verificar_equivalencia.py 156-la-ffi-foreign-function-interface-llamar-a-c-desde-todos
```
...
> [⬅️ Parte 10](../README.md) · [📚 Índice completo](../../README.md) · [🌐 Atlas de lenguajes](../../../atlas/README.md)
