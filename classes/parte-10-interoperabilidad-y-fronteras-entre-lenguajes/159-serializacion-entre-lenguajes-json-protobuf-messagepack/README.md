...
**Libros de la parte** — el marco conceptual con el que esta clase trata «Serialización entre lenguajes: JSON, Protobuf, MessagePack»:

- M. Kleppmann — *Designing Data-Intensive Applications* (O'Reilly). Codificación y evolución de esquemas entre sistemas heterogéneos.
- S. Newman — *Building Microservices* (2ª ed., O'Reilly). El límite de servicio como frontera entre lenguajes.
- A. Tanenbaum y M. van Steen — *Distributed Systems* (3ª ed.). Lo que se rompe cuando la frontera deja de ser local.
