...
Comprender **procesos y comunicación: stdin/stdout, sockets, colas** como conocimiento transferible: su forma independiente del lenguaje, cómo se expresa en el núcleo de 10 lenguajes y qué cambia (sintáctica, semántica o paradigmáticamente) de una familia a otra.
...
```bash
python scripts/verificar_equivalencia.py 161-procesos-y-comunicacion-stdin-stdout-sockets-colas
```
