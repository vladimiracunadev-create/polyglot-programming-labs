...
Comprender **elegir el lenguaje correcto para cada componente** como conocimiento transferible: su forma independiente del lenguaje, cómo se expresa en el núcleo de 10 lenguajes y qué cambia (sintáctica, semántica o paradigmáticamente) de una familia a otra.
...
```bash
python scripts/verificar_equivalencia.py 164-elegir-el-lenguaje-correcto-para-cada-componente
```
