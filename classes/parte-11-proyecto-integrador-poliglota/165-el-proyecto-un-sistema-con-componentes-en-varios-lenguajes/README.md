...
Comprender **el proyecto: un sistema con componentes en varios lenguajes** como conocimiento transferible: su forma independiente del lenguaje, cómo se expresa en el núcleo de 10 lenguajes y qué cambia (sintáctica, semántica o paradigmáticamente) de una familia a otra.
...
```bash
python scripts/verificar_equivalencia.py 165-el-proyecto-un-sistema-con-componentes-en-varios-lenguajes
```
...
> [⬅️ Parte 11](../README.md) · [📚 Índice completo](../../README.md) · [🌐 Atlas de lenguajes](../../../atlas/README.md)
