...
Comprender **compilado vs. interpretado vs. transpilado vs. bytecode/vm** como conocimiento transferible: su forma independiente del lenguaje, cómo se expresa en el núcleo de 10 lenguajes y qué cambia (sintáctica, semántica o paradigmáticamente) de una familia a otra.
...
```bash
python scripts/verificar_equivalencia.py 030-compilado-vs-interpretado-vs-transpilado-vs-bytecode-vm
```
