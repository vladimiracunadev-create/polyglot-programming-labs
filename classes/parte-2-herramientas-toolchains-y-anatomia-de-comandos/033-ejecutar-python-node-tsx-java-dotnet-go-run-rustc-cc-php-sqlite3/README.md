...
Comprender **ejecutar: python, node, tsx, java, dotnet, go run, rustc, cc, php, sqlite3** como conocimiento transferible: su forma independiente del lenguaje, cómo se expresa en el núcleo de 10 lenguajes y qué cambia (sintáctica, semántica o paradigmáticamente) de una familia a otra.
...
```bash
python scripts/verificar_equivalencia.py 033-ejecutar-python-node-tsx-java-dotnet-go-run-rustc-cc-php-sqlite3
```
