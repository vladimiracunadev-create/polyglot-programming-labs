...
Comprender **compilar y construir: gcc/clang, cargo, go build, javac, dotnet build** como conocimiento transferible: su forma independiente del lenguaje, cómo se expresa en el núcleo de 10 lenguajes y qué cambia (sintáctica, semántica o paradigmáticamente) de una familia a otra.
...
```bash
python scripts/verificar_equivalencia.py 034-compilar-y-construir-gcc-clang-cargo-go-build-javac-dotnet-build
```
