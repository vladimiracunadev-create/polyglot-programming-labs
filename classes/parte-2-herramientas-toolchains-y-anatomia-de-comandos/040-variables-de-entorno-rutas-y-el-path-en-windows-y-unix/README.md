...
Comprender **variables de entorno, rutas y el path en windows y unix** como conocimiento transferible: su forma independiente del lenguaje, cómo se expresa en el núcleo de 10 lenguajes y qué cambia (sintáctica, semántica o paradigmáticamente) de una familia a otra.
...
```bash
python scripts/verificar_equivalencia.py 040-variables-de-entorno-rutas-y-el-path-en-windows-y-unix
```
