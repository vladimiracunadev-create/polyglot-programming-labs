...
Comprender **operadores y expresiones: aritméticos, lógicos, de comparación y bit a bit** como conocimiento transferible: su forma independiente del lenguaje, cómo se expresa en el núcleo de 10 lenguajes y qué cambia (sintáctica, semántica o paradigmáticamente) de una familia a otra.
...
```bash
python scripts/verificar_equivalencia.py 055-operadores-y-expresiones-aritmeticos-logicos-de-comparacion-y-bit-a-bit
```
