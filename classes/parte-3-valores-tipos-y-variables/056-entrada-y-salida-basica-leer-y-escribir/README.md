...
Comprender **entrada y salida básica: leer y escribir** como conocimiento transferible: su forma independiente del lenguaje, cómo se expresa en el núcleo de 10 lenguajes y qué cambia (sintáctica, semántica o paradigmáticamente) de una familia a otra.
...
```bash
python scripts/verificar_equivalencia.py 056-entrada-y-salida-basica-leer-y-escribir
```
