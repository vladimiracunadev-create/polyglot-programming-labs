...
**Libros de la parte** — el marco conceptual con el que esta clase trata «Expresiones condicionales: ternario e if como expresión»:

- O.-J. Dahl, E. W. Dijkstra y C. A. R. Hoare — *Structured Programming* (Academic Press). Secuencia, selección e iteración como base suficiente del control.
