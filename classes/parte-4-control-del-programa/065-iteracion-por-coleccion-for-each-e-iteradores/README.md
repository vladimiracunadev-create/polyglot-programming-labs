...
Comprender **iteración por colección: for-each e iteradores** como conocimiento transferible: su forma independiente del lenguaje, cómo se expresa en el núcleo de 10 lenguajes y qué cambia (sintáctica, semántica o paradigmáticamente) de una familia a otra.
...
```bash
python scripts/verificar_equivalencia.py 065-iteracion-por-coleccion-for-each-e-iteradores
```
