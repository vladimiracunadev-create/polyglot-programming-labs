...
Comprender **firma, parámetros, argumentos y retorno** como conocimiento transferible: su forma independiente del lenguaje, cómo se expresa en el núcleo de 10 lenguajes y qué cambia (sintáctica, semántica o paradigmáticamente) de una familia a otra.
...
```bash
python scripts/verificar_equivalencia.py 073-firma-parametros-argumentos-y-retorno
```
