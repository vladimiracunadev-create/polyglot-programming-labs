...
**Libros de la parte** — el marco conceptual con el que esta clase trata «Funciones puras y efectos secundarios»:
...
- J. Bloch — *Effective Java* (3ª ed., Addison-Wesley) (ítem sobre minimizar la mutabilidad). Diseño de métodos: firmas, parámetros y contratos.
