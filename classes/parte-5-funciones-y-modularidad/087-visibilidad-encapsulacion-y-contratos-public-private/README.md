...
Comprender **visibilidad, encapsulación y contratos (public/private)** como conocimiento transferible: su forma independiente del lenguaje, cómo se expresa en el núcleo de 10 lenguajes y qué cambia (sintáctica, semántica o paradigmáticamente) de una familia a otra.
...
```bash
python scripts/verificar_equivalencia.py 087-visibilidad-encapsulacion-y-contratos-public-private
```
...
> [⬅️ Parte 5](../README.md) · [📚 Índice completo](../../README.md) · [🌐 Atlas de lenguajes](../../../atlas/README.md)
