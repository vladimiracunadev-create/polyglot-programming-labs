...
> [⬅️ Volver a la clase 089](README.md) · [🧬 Primos del Atlas](primos.md) ·
...
- **Entrada / salida:** stdin: una línea `a b c` (tres enteros) → stdout: `suma=<a+b+c> max=<el mayor>`
...
⏮️ [Volver a la clase 089](README.md) · 🧬 [Los primos del Atlas](primos.md) ·
