# 🧟 El mismo problema en los lenguajes que siguen vivos — Clase 094

> [⬅️ Volver a la clase 094](README.md) · [🧬 Primos del Atlas](primos.md) ·
...
- **Entrada / salida:** stdin: una línea con enteros separados por espacio → stdout: `unicos=<cantidad de valores distintos>`
...
⏮️ [Volver a la clase 094](README.md) · 🧬 [Los primos del Atlas](primos.md) ·
