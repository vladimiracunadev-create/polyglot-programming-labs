# 🧟 El mismo problema en los lenguajes que siguen vivos — Clase 099

> [⬅️ Volver a la clase 099](README.md) · [🧬 Primos del Atlas](primos.md) ·
...
- **Entrada / salida:** stdin: una línea `nombre edad` (una palabra y un entero) → stdout: `Persona(nombre=<nombre>, edad=<edad>)`
...
⏮️ [Volver a la clase 099](README.md) · 🧬 [Los primos del Atlas](primos.md) ·
