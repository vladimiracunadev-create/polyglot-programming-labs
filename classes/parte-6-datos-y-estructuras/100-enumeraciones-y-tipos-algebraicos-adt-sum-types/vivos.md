# 🧟 El mismo problema en los lenguajes que siguen vivos — Clase 100

> [⬅️ Volver a la clase 100](README.md) · [🧬 Primos del Atlas](primos.md) ·
...
- **Entrada / salida:** stdin: una línea: `cuadrado <lado>` o `rectangulo <ancho> <alto>` → stdout: `area=<área calculada>`
...
⏮️ [Volver a la clase 100](README.md) · 🧬 [Los primos del Atlas](primos.md) ·
