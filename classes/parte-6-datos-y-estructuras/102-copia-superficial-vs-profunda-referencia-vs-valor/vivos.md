# 🧟 El mismo problema en los lenguajes que siguen vivos — Clase 102

> [⬅️ Volver a la clase 102](README.md) · [🧬 Primos del Atlas](primos.md) ·
...
- **Entrada / salida:** stdin: una línea con enteros separados por espacio → stdout: `original=<lista> copia=<lista con el último cambiado a 99>` (unidos por -)
...
⏮️ [Volver a la clase 102](README.md) · 🧬 [Los primos del Atlas](primos.md) ·
