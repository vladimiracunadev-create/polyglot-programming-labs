# 🧟 El mismo problema en los lenguajes que siguen vivos — Clase 103

> [⬅️ Volver a la clase 103](README.md) · [🧬 Primos del Atlas](primos.md) ·
...
- **Entrada / salida:** stdin: un entero `n` (valor del recurso) → stdout: `valor=<n> estado=liberado`
...
⏮️ [Volver a la clase 103](README.md) · 🧬 [Los primos del Atlas](primos.md) ·
