# 🧟 El mismo problema en los lenguajes que siguen vivos — Clase 104

> [⬅️ Volver a la clase 104](README.md) · [🧬 Primos del Atlas](primos.md) ·
...
- **Entrada / salida:** stdin: una línea de texto (puede contener espacios) → stdout: `palabras=<número de palabras> caracteres=<longitud incluyendo espacios>`
...
⏮️ [Volver a la clase 104](README.md) · 🧬 [Los primos del Atlas](primos.md) ·
