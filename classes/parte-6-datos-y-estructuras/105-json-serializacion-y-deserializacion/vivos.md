# 🧟 El mismo problema en los lenguajes que siguen vivos — Clase 105

> [⬅️ Volver a la clase 105](README.md) · [🧬 Primos del Atlas](primos.md) ·
...
- **Entrada / salida:** stdin: una línea `nombre edad` (una palabra y un entero) → stdout: `{"nombre": "<nombre>", "edad": <edad>}`
...
⏮️ [Volver a la clase 105](README.md) · 🧬 [Los primos del Atlas](primos.md) ·
