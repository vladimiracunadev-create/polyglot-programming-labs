...
Comprender **otros formatos y persistencia: csv, yaml, binarios, bases de datos** como conocimiento transferible: su forma independiente del lenguaje, cómo se expresa en el núcleo de 10 lenguajes y qué cambia (sintáctica, semántica o paradigmáticamente) de una familia a otra.
...
```bash
python scripts/verificar_equivalencia.py 106-otros-formatos-y-persistencia-csv-yaml-binarios-bases-de-datos
```
...
> [⬅️ Parte 6](../README.md) · [📚 Índice completo](../../README.md) · [🌐 Atlas de lenguajes](../../../atlas/README.md)
