# 🧟 El mismo problema en los lenguajes que siguen vivos — Clase 111

> [⬅️ Volver a la clase 111](README.md) · [🧬 Primos del Atlas](primos.md) ·
...
- **Entrada / salida:** stdin: una palabra: `perro`, `gato` o `vaca` → stdout: `sonido=<guau|miau|muu>`
...
⏮️ [Volver a la clase 111](README.md) · 🧬 [Los primos del Atlas](primos.md) ·
