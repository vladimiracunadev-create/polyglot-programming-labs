# 🧟 El mismo problema en los lenguajes que siguen vivos — Clase 112

> [⬅️ Volver a la clase 112](README.md) · [🧬 Primos del Atlas](primos.md) ·
...
- **Entrada / salida:** stdin: una línea: `cuadrado <lado>` o `rectangulo <ancho> <alto>` → stdout: `area=<área>`
...
⏮️ [Volver a la clase 112](README.md) · 🧬 [Los primos del Atlas](primos.md) ·
