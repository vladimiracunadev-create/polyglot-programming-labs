# 🧟 El mismo problema en los lenguajes que siguen vivos — Clase 115

> [⬅️ Volver a la clase 115](README.md) · [🧬 Primos del Atlas](primos.md) ·
...
- **Entrada / salida:** stdin: un entero `n` → stdout: `resultado=<2n+1>` (doblar y luego incrementar)
...
⏮️ [Volver a la clase 115](README.md) · 🧬 [Los primos del Atlas](primos.md) ·
