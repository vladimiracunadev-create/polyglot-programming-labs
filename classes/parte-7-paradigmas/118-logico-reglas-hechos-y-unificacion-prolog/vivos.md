...
> [⬅️ Volver a la clase 118](README.md) · [🧬 Primos del Atlas](primos.md) ·
...
- **Entrada / salida:** stdin: una línea `a b` (dos enteros, a != 0) → stdout: `divisor=<true|false>` (¿a divide a b?)
...
⏮️ [Volver a la clase 118](README.md) · 🧬 [Los primos del Atlas](primos.md) ·
