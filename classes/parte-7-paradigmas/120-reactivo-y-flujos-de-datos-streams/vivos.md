# 🧟 El mismo problema en los lenguajes que siguen vivos — Clase 120

> [⬅️ Volver a la clase 120](README.md) · [🧬 Primos del Atlas](primos.md) ·
...
- **Entrada / salida:** stdin: una línea con enteros separados por espacio (al menos un par) → stdout: `stream=<pares duplicados, unidos por ->`
...
⏮️ [Volver a la clase 120](README.md) · 🧬 [Los primos del Atlas](primos.md) ·
