# 🧟 El mismo problema en los lenguajes que siguen vivos — Clase 121

> [⬅️ Volver a la clase 121](README.md) · [🧬 Primos del Atlas](primos.md) ·
...
- **Entrada / salida:** stdin: una línea con enteros separados por espacio → stdout: `suma=<suma total>`
...
⏮️ [Volver a la clase 121](README.md) · 🧬 [Los primos del Atlas](primos.md) ·
