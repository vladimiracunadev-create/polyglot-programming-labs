# 🧟 El mismo problema en los lenguajes que siguen vivos — Clase 124

> [⬅️ Volver a la clase 124](README.md) · [🧬 Primos del Atlas](primos.md) ·
...
- **Entrada / salida:** stdin: un entero `n` (n >= 0) → stdout: `digitos=<cantidad de dígitos>`
...
⏮️ [Volver a la clase 124](README.md) · 🧬 [Los primos del Atlas](primos.md) ·
