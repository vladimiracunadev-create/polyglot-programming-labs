# 🧟 El mismo problema en los lenguajes que siguen vivos — Clase 125

> [⬅️ Volver a la clase 125](README.md) · [🧬 Primos del Atlas](primos.md) ·
...
- **Entrada / salida:** stdin: una línea `a b op` (dos enteros y un operador +, -, *) → stdout: `resultado=<a op b>`
...
⏮️ [Volver a la clase 125](README.md) · 🧬 [Los primos del Atlas](primos.md) ·
