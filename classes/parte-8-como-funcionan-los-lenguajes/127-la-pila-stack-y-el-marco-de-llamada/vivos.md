# 🧟 El mismo problema en los lenguajes que siguen vivos — Clase 127

> [⬅️ Volver a la clase 127](README.md) · [🧬 Primos del Atlas](primos.md) ·
...
- **Entrada / salida:** stdin: un entero `n` (1 <= n <= 1000) → stdout: `suma=<1+...+n> profundidad=<n>`
...
⏮️ [Volver a la clase 127](README.md) · 🧬 [Los primos del Atlas](primos.md) ·
