...
Comprender **el modelo de memoria y las condiciones de carrera** como conocimiento transferible: su forma independiente del lenguaje, cómo se expresa en el núcleo de 10 lenguajes y qué cambia (sintáctica, semántica o paradigmáticamente) de una familia a otra.
...
```bash
python scripts/verificar_equivalencia.py 136-el-modelo-de-memoria-y-las-condiciones-de-carrera
```
