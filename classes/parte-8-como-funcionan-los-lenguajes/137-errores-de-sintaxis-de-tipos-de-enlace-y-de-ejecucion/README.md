...
Comprender **errores: de sintaxis, de tipos, de enlace y de ejecución** como conocimiento transferible: su forma independiente del lenguaje, cómo se expresa en el núcleo de 10 lenguajes y qué cambia (sintáctica, semántica o paradigmáticamente) de una familia a otra.
...
```bash
python scripts/verificar_equivalencia.py 137-errores-de-sintaxis-de-tipos-de-enlace-y-de-ejecucion
```
...
> [⬅️ Parte 8](../README.md) · [📚 Índice completo](../../README.md) · [🌐 Atlas de lenguajes](../../../atlas/README.md)
