...
Comprender **pruebas de integración y el verificador de equivalencia** como conocimiento transferible: su forma independiente del lenguaje, cómo se expresa en el núcleo de 10 lenguajes y qué cambia (sintáctica, semántica o paradigmáticamente) de una familia a otra.
...
```bash
python scripts/verificar_equivalencia.py 140-pruebas-de-integracion-y-el-verificador-de-equivalencia
```
