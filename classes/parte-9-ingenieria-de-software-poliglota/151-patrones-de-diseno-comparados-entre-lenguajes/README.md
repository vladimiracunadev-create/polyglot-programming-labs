...
Comprender **patrones de diseño comparados entre lenguajes** como conocimiento transferible: su forma independiente del lenguaje, cómo se expresa en el núcleo de 10 lenguajes y qué cambia (sintáctica, semántica o paradigmáticamente) de una familia a otra.
...
```bash
python scripts/verificar_equivalencia.py 151-patrones-de-diseno-comparados-entre-lenguajes
```
